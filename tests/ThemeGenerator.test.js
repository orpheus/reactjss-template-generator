...
describe('ThemeGenerator', () => {
	...
	it('from custom palette', () => {
		const palette = {"light":{"primary":"#394949","secondary":"#1d1da2","tertiary":"#74df74","background":"#744f4f","text":"#ff3838","success":"#647964","warning":"#9b907c","danger":"#df5c5c","info":"#4f4f91"},"dark":{"primary":"#383850","secondary":"#8d8d56","tertiary":"#d833d8","background":"#967373","text":"#af3636","success":"#7cbd7c","warning":"#f0ae35","danger":"#ad8282","info":"#19198f"}}
		const themegen = new ThemeGenerator(palette)
		expect(themegen.getPalettes()).toEqual(  { light:
				{ primary: '#394949',
					secondary: '#1d1da2',
					tertiary: '#74df74',
					background: '#744f4f',
